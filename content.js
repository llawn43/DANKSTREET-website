/* =========================================================================
   ...
   -------------------------------------------------------------------------
   Canonical tour source: End of Summer Run calendar + Linktree ticket URLs.
   Excel (DANK STREET_Tour_Info.xlsx) is regenerated to match this list.
   Other sources: Spotify / Apple Music / Beatport / 2026 media kit photos.
   ========================================================================= */
window.DANK_STREET = {
  /* --- Identity ------------------------------------------------------- */
  name: "DANK STREET",
  ...
  bio:
    ...
    "Selections draw from bass house, trap, and UK garage — relentless underground energy. " +
    "Releases with No Hype Music and Deep Legends. Co-owner of Sound Selectas. " +
    "Bookings & promo: dankstreets@gmail.com",
  billing:
    "Shared bills with Jauz, AC Slater, Habstrakt, Dirt Monkey, GG Magree, and more.",
  ...
  tracks: [
    {
      ...
      links: [
        ...
        { label: "Apple Music", url: "https://music.apple.com/us/album/en-la-calle-single/6781247702" },
        { label: "Beatport", url: "https://www.beatport.com/artist/dank-street/1310487" },
      ],
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Apple Music", url: "https://music.apple.com/us/album/ride-out-single/6767954184" },
        { label: "Beatport", url: "https://www.beatport.com/artist/dank-street/1310487" },
      ],
    ...
    },
    {
      ...
      links: [
        ...
        { label: "SoundCloud", url: "https://soundcloud.com/dankstreet" },
        { label: "Apple Music", url: "https://music.apple.com/us/album/get-down-ep/1885287949" },
        { label: "Beatport", url: "https://www.beatport.com/artist/dank-street/1310487" },
      ],
    ...
    },
    {
      ...
      links: [
        ...
        { label: "SoundCloud", url: "https://soundcloud.com/dankstreet" },
        { label: "Apple Music", url: "https://music.apple.com/us/album/no-disrespect-single/1888025127" },
        { label: "Beatport", url: "https://www.beatport.com/artist/dank-street/1310487" },
      ],
    ...
    },
    {
      ...
      links: [
        ...
        { label: "SoundCloud", url: "https://soundcloud.com/dankstreet" },
        { label: "Apple Music", url: "https://music.apple.com/us/album/attack-single/1872323770" },
        { label: "Beatport", url: "https://www.beatport.com/artist/dank-street/1310487" },
      ],
    ...
    },
    {
      ...
      links: [
        ...
        { label: "SoundCloud", url: "https://soundcloud.com/dankstreet" },
        { label: "Apple Music", url: "https://music.apple.com/us/album/pray-for-em-single/1816777525" },
        { label: "Beatport", url: "https://www.beatport.com/artist/dank-street/1310487" },
      ],
  ...
  tour: [
    ...
    },
    {
      ...
      isoDate: "2026-08-29",
      city: "Philadelphia, PA",
      venue: "The Ave Live — Shipwrek",
      tickets: "https://link.dice.fm/c1bz5d1wv4b?sharer_id=611426e0b7dc4d0001474bb1",
    },
    {
      date: "AUG 30",
      isoDate: "2026-08-30",
      city: "Philadelphia, PA",
      venue: "Liberty Point — Day Fest / Sound Selectas Takeover",
      tickets: "https://partiful.com/e/rRWjcKVqLBUeMm4AYtti?c=9qPMOeBk",
    },
    {
      date: "SEP 05",
      isoDate: "2026-09-05",
      ...
      tickets:
        "https://theticketing.co/e/vertigo?utm_source=dankstreet&utm_medium=site&utm_campaign=tour",
    },
    {
      date: "SEP 11",
      isoDate: "2026-09-11",
    ...
    },
    {
      ...
      tickets: "https://linkstub.com/UwncJlcoIU?ref=SCHFH",
    },
  ],

  /* Explicit past archive (Elements 8/07 and earlier). Upcoming past dates
     also move here automatically via isoDate filtering in router.js. */
  tourPast: [
    {
      date: "AUG 07",
      isoDate: "2026-08-07",
  ...
  media: {
    ...
    photos: [
      ...
      { src: "assets/img/photos/live-06-otherworld-2.jpg", alt: "DANK STREET live set" },
      { src: "assets/img/photos/live-05-press.jpg", alt: "DANK STREET press shot" },
      { src: "assets/img/photos/poster-01.jpg", alt: "Barbary set frame" },
      { src: "assets/img/photos/poster-02.jpg", alt: "Live set frame" },
  ...
  socials: [
    ...
    {
      label: "Beatport",
      url: "https://www.beatport.com/artist/dank-street/1310487",
      icon: "assets/img/social/beatport.svg",
    },
  ],

  /* --- Merch (Feature.fm waitlist until product drop) ----------------- */
  merch: {
    heading: "Merch",
    status: "Coming soon",
    blurb:
  ...
  contact: {
    ...
    /* FormSubmit — no account required; first submit confirms the inbox. */
    formEndpoint: "https://formsubmit.co/ajax/dankstreets@gmail.com",
    lines: [{ label: "Bookings / Promo", value: "dankstreets@gmail.com" }],
  },

  /* --- Analytics (Plausible; enable domain in plausible.io) ----------- */
  analytics: {
    plausibleDomain: "dankstreetmusic.com",
  },
};
